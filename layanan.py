def input_servis_data():
        # Implementasi logika untuk memasukkan data layanan servis
        ...
        tanggal = input("Masukkan tanggal layanan: ")

        # Melakukan operasi lain seperti memasukkan data ke database
